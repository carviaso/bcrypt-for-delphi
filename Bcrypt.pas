...
begin
	Result :=
			...
			SelfTestG and  //72 byte key length (71characters + 1 null = 72)
			SelfTestH;
end;
...
begin
	...
	Result := TBCrypt.CheckPassword(szPassword, '$2a$04$yKk0PJOqTNJOkF5Kvm6rqeARe7elBpc2jM4x60sjNLSrE/UlRCroy', {out}rehashNeeded);
end;
