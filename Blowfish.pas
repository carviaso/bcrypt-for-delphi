...
function BlowfishSelfTest;
	...
	begin
		...
		nIn := ByteSwap(Int64($FEDCBA9876543210));
		nOut := ByteSwap(nOut);
...
begin
	...
	t2(Int64($0000000000000000), Int64($0000000000000000), Int64($4EF997456198DD78));
	t2(Int64($FFFFFFFFFFFFFFFF), Int64($FFFFFFFFFFFFFFFF), Int64($51866FD5B85ECB8A));
	t2(Int64($3000000000000000), Int64($1000000000000001), Int64($7D856F9A613063F2));
	t2(Int64($1111111111111111), Int64($1111111111111111), Int64($2466DD878B963C9D));
	t2(Int64($0123456789ABCDEF), Int64($1111111111111111), Int64($61F9C3802281B096));
	t2(Int64($1111111111111111), Int64($0123456789ABCDEF), Int64($7D0CC630AFDA1EC7));
	t2(Int64($0000000000000000), Int64($0000000000000000), Int64($4EF997456198DD78));
	t2(Int64($FEDCBA9876543210), Int64($0123456789ABCDEF), Int64($0ACEAB0FC6A0A28D));
	t2(Int64($7CA110454A1A6E57), Int64($01A1D6D039776742), Int64($59C68245EB05282B));
	t2(Int64($0131D9619DC1376E), Int64($5CD54CA83DEF57DA), Int64($B1B8CC0B250F09A0));
	t2(Int64($07A1133E4A0B2686), Int64($0248D43806F67172), Int64($1730E5778BEA1DA4));
	t2(Int64($3849674C2602319E), Int64($51454B582DDF440A), Int64($A25E7856CF2651EB));
	t2(Int64($04B915BA43FEB5B6), Int64($42FD443059577FA2), Int64($353882B109CE8F1A));
	t2(Int64($0113B970FD34F2CE), Int64($059B5E0851CF143A), Int64($48F4D0884C379918));
	t2(Int64($0170F175468FB5E6), Int64($0756D8E0774761D2), Int64($432193B78951FC98));
	t2(Int64($43297FAD38E373FE), Int64($762514B829BF486A), Int64($13F04154D69D1AE5));
	t2(Int64($07A7137045DA2A16), Int64($3BDD119049372802), Int64($2EEDDA93FFD39C79));
	t2(Int64($04689104C2FD3B2F), Int64($26955F6835AF609A), Int64($D887E0393C2DA6E3));
	t2(Int64($37D06BB516CB7546), Int64($164D5E404F275232), Int64($5F99D04F5B163969));
	t2(Int64($1F08260D1AC2465E), Int64($6B056E18759F5CCA), Int64($4A057A3B24D3977B));
	t2(Int64($584023641ABA6176), Int64($004BD6EF09176062), Int64($452031C1E4FADA8E));
	t2(Int64($025816164629B007), Int64($480D39006EE762F2), Int64($7555AE39F59B87BD));
	t2(Int64($49793EBC79B3258F), Int64($437540C8698F3CFA), Int64($53C55F9CB49FC019));
	t2(Int64($4FB05E1515AB73A7), Int64($072D43A077075292), Int64($7A8E7BFA937E89A3));
	t2(Int64($49E95D6D4CA229BF), Int64($02FE55778117F12A), Int64($CF9C5D7A4986ADB5));
	t2(Int64($018310DC409B26D6), Int64($1D9D5C5018F728C2), Int64($D1ABB290658BC778));
	t2(Int64($1C587F1C13924FEF), Int64($305532286D6F295A), Int64($55CB3774D13EF201));
	t2(Int64($0101010101010101), Int64($0123456789ABCDEF), Int64($FA34EC4847B268B2));
	t2(Int64($1F1F1F1F0E0E0E0E), Int64($0123456789ABCDEF), Int64($A790795108EA3CAE));
	t2(Int64($E0FEE0FEF1FEF1FE), Int64($0123456789ABCDEF), Int64($C39E072D9FAC631D));
	t2(Int64($0000000000000000), Int64($FFFFFFFFFFFFFFFF), Int64($014933E0CDAFF6E4));
	t2(Int64($FFFFFFFFFFFFFFFF), Int64($0000000000000000), Int64($F21E9A77B71C49BC));
	t2(Int64($0123456789ABCDEF), Int64($0000000000000000), Int64($245946885754369A));
	t2(Int64($FEDCBA9876543210), Int64($FFFFFFFFFFFFFFFF), Int64($6B5C5A9C5D9E0A5A));

	//Encrypting [FEDCBA9876543210] with variable key length
	//(expectedCiperOutput, numberOfBytesToUseFromSourceKey)
	t3(Int64($F9AD597C49DB005E), 1);
	t3(Int64($E91D21C1D961A6D6), 2);
	t3(Int64($E9C2B70A1BC65CF3), 3);
	t3(Int64($BE1E639408640F05), 4);
	t3(Int64($B39E44481BDB1E6E), 5);
	t3(Int64($9457AA83B1928C0D), 6);
	t3(Int64($8BB77032F960629D), 7);
	t3(Int64($E87A244E2CC85E82), 8);
	t3(Int64($15750E7A4F4EC577), 9);
	t3(Int64($122BA70B3AB64AE0), 10);
	t3(Int64($3A833C9AFFC537F6), 11);
	t3(Int64($9409DA87A90F6BF2), 12);
	t3(Int64($884F80625060B8B4), 13);
	t3(Int64($1F85031C19E11968), 14);
	t3(Int64($79D9373A714CA34F), 15);
	t3(Int64($93142887EE3BE15C), 16);
	t3(Int64($03429E838CE2D14B), 17);
	t3(Int64($A4299E27469FF67B), 18);
	t3(Int64($AFD5AED1C1BC96A8), 19);
	t3(Int64($10851C0E3858DA9F), 20);
	t3(Int64($E6F51ED79B9DB21F), 21);
	t3(Int64($64A6E14AFD36B46F), 22);
	t3(Int64($80C7D7D45A5479AD), 23);
	t3(Int64($05044B62FA52D080), 24);
